...
export const COACH_REGISTRY: Record<string, CoachMetadata> = {
  ...
  kai: {
    ...
    isPremium: true,
    expertise: ['Neuroplastizität', 'HRV-Training', 'Schlafoptimierung', 'Vier-Quadranten-Analyse', 'Conscious Coaching', 'Bewusstseins-Erweiterung', 'Glaubenssatz-Transformation', 'Transformational Breakthrough', 'Hormonoptimierung', 'Neurotransmitter-Balance', 'Libido Wheel Methodology', 'Male Health Optimization', 'Testosteron-Optimierung', 'Dopamin-Regulation'],
    access: {
      tools: ['mindset_coaching', 'hrv_analysis', 'sleep_optimization', 'transformation_plan', 'conscious_assessment', 'values_alignment_check', 'belief_system_analysis', 'breakthrough_planning', 'hormone_optimization', 'libido_assessment', 'dopamine_detox_plan', 'testosterone_optimization'],
    ...
    aliases: ['kai', 'dr kai', 'dr. kai', 'kai nakamura', 'mindset coach', 'recovery coach', 'transformation coach', 'conscious coach', 'breakthrough coach', 'bewusstseins coach', 'hormone coach', 'libido coach', 'testosteron coach', 'dopamin coach']
  },

        ...
        {useBars ? (
          <div className="space-y-3">
            <div>
              ...
              <Progress value={pPct * 100} className="h-3" indicatorClassName="bg-[hsl(var(--protein))]" />
            </div>
            <div>
              <div className="flex justify-between text-xs mb-1">
                <span>Carbs</span>
              ...
              <Progress value={cPct * 100} className="h-2.5" indicatorClassName="bg-[hsl(var(--carbs))]" />
            </div>
            <div>
              <div className="flex justify-between text-xs mb-1">
                <span>Fett</span>
              ...
              <Progress value={fPct * 100} className="h-2" indicatorClassName="bg-[hsl(var(--fats))]" />
            </div>
          </div>
        ) : (
          <>
            <div className="relative mx-auto h-44 w-44">
              ...
              <div
                ...
                style={{ background: `conic-gradient(hsl(var(--protein) / 0.5) ${pPct*360}deg, hsl(var(--border) / 0.25) ${pPct*360}deg)` }}
              />
              ...
              <div className="absolute inset-[14%]">
                <div
                  className="absolute inset-0 rounded-full"
                  style={{ background: `conic-gradient(hsl(var(--carbs) / 0.45) ${cPct*360}deg, hsl(var(--border) / 0.25) ${cPct*360}deg)` }}
                />
              ...
              <div className="absolute inset-[28%]">
                <div
                  className="absolute inset-0 rounded-full"
                  style={{ background: `conic-gradient(hsl(var(--fats) / 0.5) ${fPct*360}deg, hsl(var(--border) / 0.25) ${fPct*360}deg)` }}
                />
            ...
            <div className="mt-4 space-y-1 text-sm">
              <div className="flex items-center justify-between">
                <span className="flex items-center gap-2">
                  <span className="h-2.5 w-2.5 rounded-full" style={{ backgroundColor: 'hsl(var(--protein) / 0.7)' }} />
                  Protein
                </span>
                <span className="tabular-nums">{Math.round(protein.used)}/{Math.round(protein.goal)} g</span>
              </div>
              ...
              <div className="flex items-center justify-between">
                <span className="flex items-center gap-2">
                  <span className="h-2.5 w-2.5 rounded-full" style={{ backgroundColor: 'hsl(var(--fats) / 0.7)' }} />
                  Fett
                </span>
                <span className="tabular-nums">{Math.round(fats.used)}/{Math.round(fats.goal)} g</span>
              </div>

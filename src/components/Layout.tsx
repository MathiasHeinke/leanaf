    ...
    <SidebarProvider defaultOpen={true}>
      <div className="min-h-screen relative overflow-hidden flex w-full">
        ...
        <div className="fixed inset-0 pointer-events-none overflow-hidden z-[5]">
          <div className="absolute top-20 left-10 w-32 h-32 bg-gradient-to-br from-primary/15 to-primary-glow/5 rounded-full blur-2xl animate-float-1"></div>
          <div className="absolute top-40 right-20 w-24 h-24 bg-gradient-to-br from-carbs/20 to-carbs/5 rounded-full blur-xl animate-float-2"></div>
          <div className="absolute bottom-40 left-20 w-28 h-28 bg-gradient-to-br from-fats/15 to-fats/3 rounded-full blur-2xl animate-float-3"></div>
          <div className="absolute bottom-60 right-10 w-20 h-20 bg-gradient-to-br from-protein/25 to-protein/5 rounded-full blur-xl animate-float-4"></div>
          <div className="absolute top-1/3 left-1/2 w-40 h-20 bg-gradient-to-r from-primary/8 to-transparent rounded-full blur-3xl transform -translate-x-1/2 rotate-45 animate-float-5"></div>
        </div>

    ...
    <div className="border-t bg-muted/30 p-3 text-xs">
      ...
      {row && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-2">
          ...
          <pre className="p-2 bg-background rounded-lg overflow-auto max-h-64">User Context: {JSON.stringify(row.user_context, null, 2)}</pre>
          <pre className="p-2 bg-background rounded-lg overflow-auto max-h-64">Prompt (system): {row.prompt_system}</pre>

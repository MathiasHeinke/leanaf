...
const translations = {
  de: {
    ...
    'profile.activityLevels.sedentary': 'Wenig aktiv (Bürojob, kein Sport)',
    'profile.activityLevels.light': 'Leicht aktiv (1-2km laufen/Tag, 0-1x Sport)',
    'profile.activityLevels.moderate': 'Mäßig aktiv (3-5km laufen/Tag, 1-2x Sport)',
    'profile.activityLevels.active': 'Sehr aktiv (3-4x Sport/Woche + Laufen)',
    'profile.activityLevels.very_active': 'Extrem aktiv (täglich Sport + 6km+ laufen)',
  ...
  en: {
    ...
    'profile.activityLevels.sedentary': 'Low active (office job, no sports)',
    'profile.activityLevels.light': 'Lightly active (1-2km run/day, 0-1x sports)',
    'profile.activityLevels.moderate': 'Moderately active (3-5km run/day, 1-2x sports)',
    'profile.activityLevels.active': 'Very active (3-4x sports/week + running)',
    'profile.activityLevels.very_active': 'Extremely active (daily sports + 6km+ running)',

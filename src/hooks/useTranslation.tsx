...
const translations = {
  de: {
    ...
    'profile.activityLevels.sedentary': 'Wenig aktiv (Bürojob)',
    'profile.activityLevels.light': 'Leicht aktiv (1-3x Sport/Woche)',
    'profile.activityLevels.moderate': 'Mäßig aktiv (3-5x Sport/Woche)',
    'profile.activityLevels.active': 'Sehr aktiv (6-7x Sport/Woche)',
    'profile.activityLevels.very_active': 'Extrem aktiv (2x täglich)',

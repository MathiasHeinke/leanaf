...
const translations = {
  de: {
    ...
    'bmi.obesity': 'Adipositas',
    'bmi.progress': 'BMI Fortschritt',
    'bmi.goal': 'Ziel',
    'bmi.startBMI': 'Start BMI',
    'bmi.currentBMI': 'Aktuell BMI',
    'bmi.targetBMI': 'Ziel BMI',
    'bmi.losing': 'Abnehmen',
    'bmi.gaining': 'Zunehmen',
    'bmi.achieved': 'erreicht',
    'bmi.pointsToGoal': 'BMI Punkte bis zum Ziel',
    'bmi.motivation.excellent': '🎉 Fantastisch! Du bist fast am Ziel!',
    'bmi.motivation.great': '💪 Großartig! Du bist auf dem halben Weg!',
    'bmi.motivation.good': '🚀 Super Start! Weiter so!',
    'bmi.motivation.start': '🌟 Los geht\'s! Jeder Schritt zählt!',
    
    // Meal Types & Confirmation
    'meal.type': 'Mahlzeit-Typ',
    'meal.selectType': 'Wählen Sie einen Mahlzeit-Typ',
    'meal.breakfast': 'Frühstück',
    'meal.lunch': 'Mittagessen',
    'meal.dinner': 'Abendessen',
    'meal.snack': 'Snack',
    'meal.confirm': 'Mahlzeit bestätigen & bearbeiten',
    'meal.title': 'Mahlzeit-Titel',
    'meal.nutrition': 'Nährwerte (bearbeitbar)',
    'meal.calories': 'Kalorien',
    'meal.protein': 'Protein',
    'meal.carbs': 'Kohlenhydrate',
    'meal.fats': 'Fette',
    'meal.date': 'Datum der Mahlzeit',
    'meal.cancel': 'Abbrechen',
    'meal.save': 'Mahlzeit speichern',
    'meal.saveSuccess': 'Mahlzeit erfolgreich gespeichert',
    'meal.saveError': 'Fehler beim Speichern der Mahlzeit',
    
    // Coach Personalities
    'coach.personalities.motivating': 'Motivierend',
    'coach.personalities.tough': 'Hart',
    'coach.personalities.soft': 'Soft',
    'coach.personalities.funny': 'Lustig',
    'coach.personalities.ironic': 'Ironisch',
    'coach.preview': 'Vorschau',
    'coach.preview.tough': '"Du hast dein Ziel heute nicht erreicht? Dann streng dich morgen mehr an!"',
    'coach.preview.soft': '"Das ist völlig in Ordnung, morgen ist ein neuer Tag für einen Neuanfang."',
    'coach.preview.motivating': '"Du schaffst das! Ich glaube an dich und deine Ziele!"',
    ...
    'profile.activity.sedentary': 'Wenig aktiv',
    ...
    'profile.activityLevels.sedentary': 'Bürojob, wenig Bewegung',
    'profile.activityLevels.light': 'Gelegentliche Spaziergänge, 1-2x Sport/Woche',
    'profile.activityLevels.moderate': 'Regelmäßige Bewegung, 3-4x Sport/Woche',
    'profile.activityLevels.active': 'Tägliche Bewegung, 5-6x Sport/Woche',
    'profile.activityLevels.very_active': 'Intensive tägliche Aktivität, Leistungssport',
    ...
    'profile.coachPersonalities.soft': 'Sanft & Verständnisvoll',
    ...
    'history.avgCaloriesPerDay': 'Ø Kalorien/Tag',
    'history.goalsReached': 'Ziele erreicht',
    'history.status.goalReached': 'Ziel erreicht',
    'history.status.nearGoal': 'Nahe Ziel',
    'history.status.overGoal': 'Über Ziel',
    'history.status.tooLittle': 'Zu wenig',
    'history.status.deviation': 'Abweichung',
    'history.mealTypes.breakfast': '🌅 Frühstück',
    'history.mealTypes.lunch': '🌞 Mittagessen',
    'history.mealTypes.dinner': '🌆 Abendessen',
    'history.mealTypes.snack': '🍎 Snack',
    'history.mealTypes.other': '🍽️ Sonstiges',
    ...
    'history.nutritionPer100g': 'Nährwerte pro 100g',
    ...
    'meal.addFirstMeal': 'Füge deine erste Mahlzeit hinzu',
    'meal.todaysMeals': 'Heutige Mahlzeiten',
    
    // Toast Messages
    'toast.success.tipSaved': 'Tipp gespeichert',
    'toast.success.mealDeleted': 'Mahlzeit gelöscht',
    ...
    'toast.error.deletingMeal': 'Fehler beim Löschen der Mahlzeit',
    ...
    'toast.error.invalidGoal': 'Ungültiges Ziel eingegeben',
    ...
    'status.needsImprovement': 'Verbesserung nötig',
  ...
  en: {
    ...
    'bmi.obesity': 'Obesity',
    'bmi.progress': 'BMI Progress',
    'bmi.goal': 'Goal',
    'bmi.startBMI': 'Start BMI',
    'bmi.currentBMI': 'Current BMI',
    'bmi.targetBMI': 'Target BMI',
    'bmi.losing': 'Losing',
    'bmi.gaining': 'Gaining',
    'bmi.achieved': 'achieved',
    'bmi.pointsToGoal': 'BMI points to goal',
    'bmi.motivation.excellent': '🎉 Fantastic! You\'re almost at your goal!',
    'bmi.motivation.great': '💪 Great! You\'re halfway there!',
    'bmi.motivation.good': '🚀 Great start! Keep it up!',
    'bmi.motivation.start': '🌟 Let\'s go! Every step counts!',
    
    // Meal Types & Confirmation
    'meal.type': 'Meal Type',
    'meal.selectType': 'Select a meal type',
    'meal.breakfast': 'Breakfast',
    'meal.lunch': 'Lunch',
    'meal.dinner': 'Dinner',
    'meal.snack': 'Snack',
    'meal.confirm': 'Confirm & edit meal',
    'meal.title': 'Meal Title',
    'meal.nutrition': 'Nutrition (editable)',
    ...
    'meal.cancel': 'Cancel',
    'meal.save': 'Save meal',
    'meal.saveSuccess': 'Meal saved successfully',
    'meal.saveError': 'Error saving meal',
    
    // Coach Personalities
    'coach.personalities.motivating': 'Motivating',
    'coach.personalities.tough': 'Tough',
    'coach.personalities.soft': 'Soft',
    'coach.personalities.funny': 'Funny',
    'coach.personalities.ironic': 'Ironic',
    'coach.preview': 'Preview',
    'coach.preview.tough': '"You didn\'t reach your goal today? Then try harder tomorrow!"',
    'coach.preview.soft': '"That\'s completely fine, tomorrow is a new day for a fresh start."',
    'coach.preview.motivating': '"You can do it! I believe in you and your goals!"',
    ...
    'profile.activityLevels.sedentary': 'Office job, little movement',
    'profile.activityLevels.light': 'Occasional walks, 1-2x sports/week',
    'profile.activityLevels.moderate': 'Regular movement, 3-4x sports/week',
    'profile.activityLevels.active': 'Daily movement, 5-6x sports/week',
    'profile.activityLevels.very_active': 'Intensive daily activity, competitive sports',
    ...
    'history.mealTypes.breakfast': '🌅 Breakfast',
    'history.mealTypes.lunch': '🌞 Lunch',
    'history.mealTypes.dinner': '🌆 Dinner',
    'history.mealTypes.snack': '🍎 Snack',
    'history.mealTypes.other': '🍽️ Other',

...
const SUPPLIERS_DATA = [
  ...
  { name: 'Peptide Power EU', country: 'EU', website: 'peptidepowereu.com', shipping_to_de: true, quality_tier: 'verified', notes: 'EU-basiert. Pre-filled Pens. Spezialisiert auf GHK-Cu, Ipamorelin, CJC-1295.' },
  { name: 'Verified Peptides', country: 'EU', website: 'verifiedpeptides.eu', shipping_to_de: true, quality_tier: 'verified', notes: 'EU-Shipping. Third-party tested. Spezialisiert auf BPC-157, TB-500, Ipamorelin, Blends.' },
  ...
  { name: 'Cell Peptides', country: 'EU', website: 'cellpeptides.com', shipping_to_de: true, quality_tier: 'verified', notes: 'Longevity-Peptide Spezialist. Spezialisiert auf MOTS-c, SS-31.' },
  ...
  { name: 'Biowell Labs', country: 'EU', website: 'biowelllabs.com', shipping_to_de: true, quality_tier: 'standard', notes: 'Neuere Compounds. Spezialisiert auf Retatrutide, GHK-Cu, Metabolic.' },
  { name: 'DN Research', country: 'EU', website: 'dnresearch.eu', shipping_to_de: true, quality_tier: 'verified', notes: 'GMP EU. Pre-filled Pens. Spezialisiert auf Retatrutide, GLP-1.' },
  ...
  { name: 'Peptide Sciences', country: 'US', website: 'peptidesciences.com', shipping_to_de: true, quality_tier: 'verified', notes: 'US-Premium. Third-party HPLC. Zoll-Risiko. Spezialisiert auf MOTS-c, Research-Grade.' },

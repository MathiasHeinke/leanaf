...
const SUPPLIERS_DATA = [
  { name: 'BPS Pharma', country: 'DE', website: 'bps-pharma.de', shipping_to_de: true, quality_tier: 'verified', specialization: ['BPC-157', 'TB-500', 'Epitalon', 'Blends'], notes: 'Deutscher Shop. BPC-157 Tropfen verfügbar.' },
  { name: 'Peptide Power EU', country: 'EU', website: 'peptidepowereu.com', shipping_to_de: true, quality_tier: 'verified', specialization: ['GHK-Cu', 'Ipamorelin', 'CJC-1295', 'Pre-filled Pens'], notes: 'EU-basiert. Pre-filled Pens.' },
  { name: 'Verified Peptides', country: 'EU', website: 'verifiedpeptides.eu', shipping_to_de: true, quality_tier: 'verified', specialization: ['BPC-157', 'TB-500', 'Ipamorelin', 'Blends'], notes: 'EU-Shipping. Third-party tested.' },
  { name: 'Core Peptides', country: 'EU', website: 'corepeptides.eu', shipping_to_de: true, quality_tier: 'standard', specialization: ['MOTS-c', 'BPC-157', 'TB-500', 'Ipamorelin'], notes: 'EU-Lab. Research only.' },
  { name: 'Cell Peptides', country: 'EU', website: 'cellpeptides.com', shipping_to_de: true, quality_tier: 'verified', specialization: ['MOTS-c', 'SS-31', 'Longevity Peptides'], notes: 'Longevity-Peptide Spezialist.' },
  { name: 'PharmaLabGlobal EU', country: 'EU', website: 'pharmalabglobal.eu', shipping_to_de: true, quality_tier: 'standard', specialization: ['Epitalon', 'Allgemein'], notes: 'Breites Sortiment. EU-Shipping.' },
  { name: 'Biowell Labs', country: 'EU', website: 'biowelllabs.com', shipping_to_de: true, quality_tier: 'standard', specialization: ['Retatrutide', 'GHK-Cu', 'Metabolic'], notes: 'Neuere Compounds.' },
  { name: 'DN Research', country: 'EU', website: 'dnresearch.eu', shipping_to_de: true, quality_tier: 'verified', specialization: ['Retatrutide', 'GLP-1', 'Pre-filled Pens'], notes: 'GMP EU. Pre-filled Pens.' },
  { name: '24Peptides', country: 'EU', website: '24peptides.com', shipping_to_de: true, quality_tier: 'standard', specialization: ['Retatrutide', 'Allgemein'], notes: '99.7%+ Reinheit.' },
  { name: 'UK-Peptides', country: 'UK', website: 'uk-peptides.com', shipping_to_de: true, quality_tier: 'standard', specialization: ['Epitalon', 'BPC-157', 'Allgemein'], notes: 'UK-basiert. Günstig.' },
  { name: 'Peptide Regenesis', country: 'UK', website: 'peptideregenesis.co.uk', shipping_to_de: true, quality_tier: 'standard', specialization: ['SS-31', 'Longevity'], notes: 'SS-31 Spezialist.' },
  { name: 'Peptide Sciences', country: 'US', website: 'peptidesciences.com', shipping_to_de: true, quality_tier: 'verified', specialization: ['MOTS-c', 'Allgemein', 'Research-Grade'], notes: 'US-Premium. Third-party HPLC. Zoll-Risiko.' },
  { name: 'Biotech Peptides', country: 'US', website: 'biotechpeptides.com', shipping_to_de: true, quality_tier: 'standard', specialization: ['Ipamorelin', 'CJC-1295', 'GH-Stack'], notes: 'USA-made. Zoll-Risiko.' },
  { name: 'Cosmic Nootropic', country: 'RU', website: 'cosmicnootropic.com', shipping_to_de: true, quality_tier: 'verified', specialization: ['Semax', 'Selank', 'Pinealon', 'DSIP'], notes: 'Import aus Russland. Semax/Selank dort zugelassen.' },
  { name: 'Synthagen Labs', country: 'EU', website: 'synthagenlab.com', shipping_to_de: true, quality_tier: 'standard', specialization: ['GHK-Cu', 'Oral Capsules'], notes: 'GHK-Cu als orale Kapseln.' },
  { name: 'BioLabShop', country: 'EU', website: 'biolabshop.eu', shipping_to_de: true, quality_tier: 'standard', specialization: ['GHK-Cu', 'Allgemein'], notes: 'Lyophilisierte Vials.' },
];
...
const STACKS_DATA = [
  { id: 'clean_gains', name: 'Clean Gains', goal: 'Kurze, hohe GH-Spikes für Muskelaufbau', category: 'muscle', protocol_phase: 2, peptides: [{ peptide_id: 'ipamorelin', peptide_name: 'Ipamorelin', dosage: '100 mcg', frequency: '1-3x täglich', timing: 'Nüchtern!' }, { peptide_id: 'cjc_1295_no_dac', peptide_name: 'CJC-1295 no DAC', dosage: '100 mcg', frequency: '1-3x täglich', timing: 'In gleicher Spritze' }], duration_weeks: 8, critical_rules: ['Absolut NÜCHTERN!', '20-30 Min warten vor dem Essen', 'Wichtigster Zeitpunkt: Vor dem Schlafen'], expected_effects: ['Synergistische GH-Ausschüttung', 'Muskelaufbau', 'Fettabbau', 'Anti-Aging'], warning: 'Research-only. Steriles Arbeiten erforderlich.' },
  { id: 'natural_testo_boost', name: 'Natural Testo-Boost', goal: 'Maximierung körpereigener Testosteron-Produktion', category: 'testo', protocol_phase: 2, peptides: [{ peptide_id: 'igf1_lr3', peptide_name: 'IGF-1 LR3', dosage: '20-50 mcg', frequency: 'Täglich (Trainingstage)', timing: 'Post-Workout' }, { peptide_id: 'kisspeptin_10', peptide_name: 'Kisspeptin-10', dosage: '100-200 mcg', frequency: 'Abends', timing: 'Spiked akut LH/FSH' }], duration_weeks: 4, critical_rules: ['IGF-1 LR3: 4 Wochen on, 4 Wochen off', 'Östrogen-Management beachten'], expected_effects: ['LH-Stimulation', 'Freies Testosteron ↑', 'Muskelaufbau-Unterstützung'], warning: 'IGF-1 LR3 kann Gynäkomastie fördern!' },
  { id: 'fettleber_reset', name: 'Fettleber-Reset', goal: 'Radikaler viszeraler Fettabbau und Lebergesundheit', category: 'metabolic', protocol_phase: 2, peptides: [{ peptide_id: 'retatrutide', peptide_name: 'Retatrutide', dosage: 'Start: 2 mg, steigern bis 8-12 mg', frequency: '1x/Woche', timing: 'Unabhängig von Mahlzeiten' }], duration_weeks: 12, critical_rules: ['Langsam auftitrieren!', 'Alle 4 Wochen Dosis steigern', 'TUDCA für Leberschutz'], expected_effects: ['Fett aus Leber mobilisiert', 'Stärkster Gewichtsverlust', 'Insulinsensitivität verbessert'], warning: 'Phase 2 Trials, nicht zugelassen. GI-Nebenwirkungen.' },
  { id: 'autoimmun_reset', name: 'Autoimmun-Reset', goal: 'Immunsystem resetten, Autoimmun-Erkrankungen lindern', category: 'immune', protocol_phase: 3, peptides: [{ peptide_id: 'kpv', peptide_name: 'KPV', dosage: '200-500 mcg', frequency: 'Täglich SubQ', timing: 'Oder oral bei Darm (Colitis)' }, { peptide_id: 'thymosin_alpha_1', peptide_name: 'Thymosin Alpha 1', dosage: '1.6 mg', frequency: '2x/Woche (Prävention)', timing: 'Standard-Vial' }, { peptide_id: 'foxo4_dri', peptide_name: 'FOXO4-DRI', dosage: '3-5 mg', frequency: 'Jeden 2. Tag für 1 Woche', timing: 'Senolytikum, dann lange Pause' }], duration_weeks: 4, critical_rules: ['FOXO4-DRI = pulsatil, nicht dauerhaft!', 'Blutbild vorher/nachher'], expected_effects: ['Systemische Entzündung ↓', 'Thymus-Regeneration', 'Zombie-Zellen eliminiert'], warning: 'Fortgeschrittenes Protokoll. Nur für erfahrene User.' },
  { id: 'perfekter_schlaf', name: 'Perfekter Schlaf', goal: 'Zirbeldrüse reparieren, Melatonin-Synthese maximieren', category: 'sleep', protocol_phase: 3, peptides: [{ peptide_id: 'epitalon', peptide_name: 'Epitalon', dosage: '10 mg/Tag für 10-20 Tage', frequency: 'Alle 6 Monate', timing: 'Khavinson-Protokoll' }, { peptide_id: 'pinealon', peptide_name: 'Pinealon', dosage: '5-10 mg oral', frequency: 'Morgens/Mittags', timing: 'Fokus + indirekter Schlaf-Support' }], duration_weeks: 2, critical_rules: ['Epitalon nur 2-3x pro Jahr als Kur', 'DSIP gilt als ineffektiv'], expected_effects: ['Melatonin-Produktion ↑', 'Telomere geschützt', 'Tiefschlaf verbessert'], warning: 'Research-only. Epitalon-Kuren zeitlich begrenzen.' },
  { id: 'nootropics_stack', name: 'Nootropics', goal: 'BDNF-Steigerung, Lernen, Angstlösung', category: 'nootropic', protocol_phase: 2, peptides: [{ peptide_id: 'semax', peptide_name: 'Semax', dosage: '200-600 mcg nasal', frequency: '2x täglich', timing: 'Morgens + Mittags' }, { peptide_id: 'selank', peptide_name: 'Selank', dosage: '200-400 mcg nasal', frequency: '2x täglich', timing: 'Anxiolytisch, keine Sedierung' }], duration_weeks: 4, critical_rules: ['4 Wochen on, 2 Wochen off', 'Nicht abends (können wach halten)'], expected_effects: ['BDNF massiv erhöht', 'Fokus und Klarheit', 'Angst reduziert ohne Sedierung'], warning: 'In Russland zugelassen, in EU als Research Chemical.' },
  { id: 'wolverine_healing', name: 'Wolverine (Healing)', goal: 'Maximale Tissue Repair bei Verletzungen', category: 'healing', protocol_phase: 2, peptides: [{ peptide_id: 'bpc_157', peptide_name: 'BPC-157', dosage: '250-500 mcg', frequency: '1-2x täglich', timing: 'Nahe der Verletzungsstelle' }, { peptide_id: 'tb_500', peptide_name: 'TB-500', dosage: '2-5 mg', frequency: '2x pro Woche', timing: 'Systemische Injektion' }], duration_weeks: 6, critical_rules: ['BPC-157 lokal, TB-500 systemisch', 'Können kombiniert werden', 'Loading Phase: Höhere Frequenz erste 2 Wochen'], expected_effects: ['Beschleunigte Wundheilung', 'Sehnen-/Bänder-Regeneration', 'Anti-inflammatorisch'], warning: 'Research-only. Beliebter Stack bei Athleten.' },
  { id: 'looksmaxxing', name: 'Looksmaxxing', goal: 'Skin Anti-Aging, Kollagen, Mitochondrien', category: 'longevity', protocol_phase: 3, peptides: [{ peptide_id: 'ghk_cu', peptide_name: 'GHK-Cu', dosage: '1-2 mg', frequency: 'Täglich oder zyklisch', timing: 'SubQ oder topisch' }, { peptide_id: 'epitalon', peptide_name: 'Epitalon', dosage: '5-10 mg', frequency: '10-20 Tage Kur', timing: 'Abends' }, { peptide_id: 'mots_c', peptide_name: 'MOTS-c', dosage: '5-10 mg', frequency: '2-3x pro Woche', timing: 'Vor Training' }, { peptide_id: 'ss_31', peptide_name: 'SS-31', dosage: '5 mg', frequency: '2x pro Woche', timing: 'Mitochondrien-Repair' }], duration_weeks: 8, critical_rules: ['GHK-Cu auch als Serum topisch nutzbar', 'Kollagen + Vitamin C supplementieren'], expected_effects: ['Kollagen-Synthese ↑', 'Haut-Elastizität verbessert', 'Mitochondrien regeneriert'], warning: 'Teures Protokoll. Research-only.' },
];

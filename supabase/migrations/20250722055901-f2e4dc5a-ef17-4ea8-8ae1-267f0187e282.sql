...
CREATE TABLE public.user_trials (
  ...
  trial_type TEXT NOT NULL DEFAULT 'premium',
...
-- Add trial multiplier to point activities for faster progression in free mode
ALTER TABLE public.point_activities 
ADD COLUMN trial_multiplier NUMERIC DEFAULT 1.0;

-- Update the update_user_points_and_level function to include trial bonus

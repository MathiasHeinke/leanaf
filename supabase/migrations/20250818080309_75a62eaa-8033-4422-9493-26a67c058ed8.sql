-- Fix console issues step by step with proper function handling
...
-- Drop existing get_my_uid function if it exists to avoid return type conflicts
...
CREATE FUNCTION public.get_my_uid()
RETURNS jsonb
LANGUAGE sql
STABLE SECURITY DEFINER
SET search_path TO 'public'

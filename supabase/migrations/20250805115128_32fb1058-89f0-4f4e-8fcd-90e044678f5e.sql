...
SET 
  ...
  content = replace(replace(content, 'Consciousness Coaching', 'Conscious Coaching'), 'Consciousness Integration', 'Conscious Integration'),
  tags = array_replace(tags, 'consciousness', 'conscious')
...
SET 
  ...
  content = replace(replace(content, 'Consciousness-Typen', 'Conscious-Typen'), 'Consciousness Coaching', 'Conscious Coaching'),
  tags = array_replace(tags, 'consciousness', 'conscious')
...
SET 
  ...
  content = replace(replace(content, 'Consciousness Assessment', 'Conscious Assessment'), 'Consciousness Coaching', 'Conscious Coaching'),
  tags = array_replace(tags, 'consciousness', 'conscious')

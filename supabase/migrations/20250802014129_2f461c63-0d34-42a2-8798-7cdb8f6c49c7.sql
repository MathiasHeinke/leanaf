-- Zuerst existierende Funktionen droppen
DROP FUNCTION IF EXISTS fast_meal_totals(uuid, date);
DROP FUNCTION IF EXISTS fast_sets_volume(uuid, date);
DROP FUNCTION IF EXISTS fast_fluid_totals(uuid, date);
DROP FUNCTION IF EXISTS get_summary_range(uuid, int);

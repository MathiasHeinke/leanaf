...
-- 2. Drop and recreate v_meal_totals view without SECURITY DEFINER
...
WITH daily_data AS (
  SELECT 
    ...
    'neutral' AS mood, -- Default mood value
...
-- 5. Drop and recreate v_workout_totals view without SECURITY DEFINER

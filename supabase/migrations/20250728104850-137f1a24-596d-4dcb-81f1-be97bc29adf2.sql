-- Dr. Vita Femina Knowledge Base - Neue Einträge

INSERT INTO public.coach_knowledge_base (
  title, expertise_area, knowledge_type, content, coach_id, priority_level, tags, source_url, created_at
) VALUES 
...
ON CONFLICT (title, coach_id) DO UPDATE SET

-- Drop ALL versions of assess_medical_risk function
DROP FUNCTION IF EXISTS assess_medical_risk(uuid, text[], text[], text[], text[]);
DROP FUNCTION IF EXISTS assess_medical_risk(uuid, uuid[], text[], uuid[], text[]);

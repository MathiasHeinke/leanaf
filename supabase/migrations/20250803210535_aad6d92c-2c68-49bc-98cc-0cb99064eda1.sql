...
-- Drop and recreate all 8 views without SECURITY DEFINER property
...
-- 7. Recreate v_coach_dashboard (Admin view) - with correct type casting
...
LEFT JOIN (
  ...
  GROUP BY conversation_id
) plan_counts ON cc.id::text = plan_counts.conversation_id

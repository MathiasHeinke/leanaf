-- Fix security issues in database functions by adding secure search paths
-- and enabling leaked password protection

-- Update all custom functions to use secure search paths
